<?php // $Id: page.tpl.php,v 1.10 2008/09/09 13:14:22 jmburnz Exp $
/**
 * @file
 *  page.tpl.php
 *
...
<head>
  ...
  <!--[if IE]>
    ...
    <?php endif; ?>
  <![endif]-->
  <link type="text/css" rel="stylesheet" media="all" href="<?php print $base_path . $directory; ?>/add_style.css" >
  <link type="text/css" rel="stylesheet" media="all" href="<?php print $base_path . $directory; ?>/contentfix.css" >

	<?php print $scripts; ?>
	    <script type="text/javascript" src="<?php print $base_path . $directory; ?>/jquery_example/jquery.example.js"></script>
	    <script type="text/javascript" src="<?php print $base_path . $directory; ?>/searchtext.js"></script>
...
<!--withsf-->
  <div id="skip-to-content"><a href="#main-content"><?php print t('Skip to Content'); ?></a></div>
    ...
    <div id="page" class="leadpage" style="width: <?php print $pixture_width; ?>;">
	...
	<!-- changed from main to main-lead -->
    <div id="main-lead" class="clear-block <?php print $header ? 'with-header-blocks' : 'no-header-blocks' ; ?>">
    
    <!-- IMPORTANT: moved into main area, just on lead page -->
    <?php if (!empty($header)): ?>
    ...
    <?php if ($footer || $footer_message || $footerlinks): ?>
      <div id="footer"><div id="footer-inner" class="region region-footer">

       <?php if ($footerlinks): ?>
         <div id="footerlinks" class="region region-footerlinks"><?php print $footerlinks; ?></div>
       <?php endif; ?>
