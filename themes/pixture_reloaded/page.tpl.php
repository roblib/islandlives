...
<head>
  ...
  <!--[if IE]>
    ...
    <?php endif; ?>
  <![endif]-->
  <?php if (arg(1) == 'ilives_book_viewer' || arg(0) == 'teieditor'): ?>
    <link type="text/css" rel="stylesheet" media="all" href="<?php print $base_path . $directory; ?>/add_small_header_style.css" >
  <? else: ?>
