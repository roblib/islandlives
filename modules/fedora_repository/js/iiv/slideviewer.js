...
iiv.Viewer.UI = new iiv.Class({
  ...
  createUI: function() {
    ...
    /*container.append('<link rel="stylesheet" href="css/jquery-ui/jquery-ui-1.7.2.custom.css" type="text/css" />');
    container.append('<link rel="stylesheet" href="css/iiv.css" type="text/css"/>');
    container.append('<!--[if lte IE 6]><link rel="stylesheet" href="css/ie6.css" type="text/css"><![endif]-->');*/
