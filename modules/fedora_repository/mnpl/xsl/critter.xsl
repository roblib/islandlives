...
<h4>Record Status</h4>
<ul>
	<li><b>Status:</b><xsl:text> </xsl:text><xsl:value-of select="/critters:sample/critters:status"/></li>
	<li><b>Notes:</b><xsl:text> </xsl:text><xsl:value-of select="/critters:sample/critters:notes"/></li>
</ul>
 <!-- <h4>Description</h4>
